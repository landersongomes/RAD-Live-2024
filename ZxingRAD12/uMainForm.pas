...
begin
  ...
  lJSON := dmComunicacao.GerarJSONCarregamento(dmComunicacao.RESTRequest1, AReadResult.text, 3, 1);
  ...
  memLog.Lines.Add(FormatDateTime('hh:nn:ss', Now) + ' Transmissão - Status code - ' +
      dmComunicacao.RESTResponseCarregamentos.StatusCode.ToString);
end;
